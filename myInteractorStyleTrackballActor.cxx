...
Module:    myInteractorStyleTrackballActor.cxx
...
//----------------------------------------------------------------------------
void myInteractorStyleTrackballActor::OnMouseMove()
{
...
//----------------------------------------------------------------------------
void myInteractorStyleTrackballActor::Dolly()
{
	if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
	{
		return;
...
//----------------------------------------------------------------------------
void myInteractorStyleTrackballActor::UniformScale()
{
	if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
	{
		return;
...
//----------------------------------------------------------------------------
void myInteractorStyleTrackballActor::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void myInteractorStyleTrackballActor::Prop3DTransform(vtkProp3D *prop3D,
	double *boxCenter,
	int numRotation,
	double **rotate,
	double *scale)
